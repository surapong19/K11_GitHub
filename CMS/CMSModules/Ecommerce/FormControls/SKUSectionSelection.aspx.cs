...
public partial class CMSModules_Ecommerce_FormControls_SKUSectionSelection : CMSModalPage, ICallbackEventHandler
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (mCreatedNodes == 0)
        {
            pnlBody.Controls.Add(new Literal { Text = LocalizationHelper.GetString("com.productsections.none") });
        }
    }
    ...
    protected TreeNode treeElem_OnNodeCreated(DataRow itemData, TreeNode defaultNode)
    {
        ...
        if (itemData != null)
        {
            ...
            string onclick = $"ProcessItem(this,'{ValidationHelper.GetHashString(treeNode.NodeID.ToString())}',false,true);";
...
function US_Submit(){{ SelectItemsReload(escape(ItemsElem().value), {hdnClientId}, {txtClientId}, {hdnDrpClientId}, {hashElementClientId}, HashElem().value); return false; }}";
    }
